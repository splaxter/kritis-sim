    ...
    choices: [
      {
        ...
        teachingMoment: 'Der dokumentierte Meldeweg (Vorgesetzte → BSI nach § 32 BSIG / NIS2) schützt dich rechtlich und sorgt dafür, dass die Meldung nicht an einer Einzelperson hängt.',
      },
      {
        id: 'go_solo',
    ...
    choices: [
      {
        ...
        teachingMoment: 'KRITIS-Betreiber sind nach § 32 BSIG / NIS2 meldepflichtig. Eine formale, dokumentierte Meldung mit Aktenzeichen ist Pflicht — und der beste Eigenschutz.',
      },
      {
...
"Wir kriegen das hin", ruft er dir zu. "Irgendwie kriegen wir das hin. Was brauchst du?"`,
    ...
    choices: [
      ...
      },
      {
        ...
        resultText: 'Du gehst mit Bert in sein Büro, ihr formuliert zusammen die Meldung. Er atmet einmal durch — "Dann machen wir es richtig und sofort" — und greift zum Hörer, ganz ruhig: "Guten Tag, hier spricht die Abfallwirtschaft, wir haben einen erheblichen Sicherheitsvorfall nach § 32." Keine Sekunde Zögern mehr.',
        setsFlags: ['crisis_reported', 'bsi_notified'],
        teachingMoment: '§ 32 BSIG (NIS2-Umsetzung): Ein erheblicher Sicherheitsvorfall geht unverzüglich ans BSI — Erstmeldung binnen 24 Stunden, Bewertung nach 72 Stunden, Abschlussmeldung nach einem Monat. Nicht erst, wenn alles aufgeräumt ist.',
      },
    ],
  },
