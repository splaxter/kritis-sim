...
export const adventureChapters: AdventureChapter[] = [
...

  {
    ...
    storyBeats: [
      ...
      { id: 'beat03', eventId: 'adv_jens_warning', isOptional: false },
...

  {
    ...
    storyBeats: [
      {
        id: 'beat01',
        eventId: 'adv_official_bsi_briefing',
        isOptional: false,
        branchCondition: 'chose_official_route',
        alternateEventId: 'adv_solo_countertrace',
      },
...

  {
    ...
    storyBeats: [
      ...
      { id: 'beat03', eventId: 'adv_jens_flashback', isOptional: false },
...

  {
    ...
    storyBeats: [
      {
        id: 'beat01',
        eventId: 'adv_contained_ransomware',
        isOptional: false,
        branchCondition: 'isolated_systems',
        alternateEventId: 'adv_ransomware_strike_uncontained',
      },
...

  {
    ...
    storyBeats: [
      ...
      {
        id: 'beat04',
        eventId: 'adv_jens_helps',
        isOptional: false,
        branchCondition: 'jens_ally',
...

  {
    ...
    storyBeats: [
      ...
      {
        id: 'beat03',
        eventId: 'adv_official_resolution',
        isOptional: false,
        branchCondition: 'chose_official_route',
        alternateEventId: 'adv_underground_resolution',
      },
...

  {
    ...
    storyBeats: [
      ...
      { id: 'beat03', eventId: 'adv_climax', isOptional: false },
      {
        ...
        isOptional: false,
        branchCondition: 'chose_official_route',
        alternateEventId: 'adv_underground_finale',
      },
    ],
    sidequests: [],
