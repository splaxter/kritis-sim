...
export const ADVENTURE_ENDINGS: Record<EndingType, AdventureEndingText> = {
  good: {
    ...
    paragraphs: [
      ...
      'Frau Dr. Reinhardt vom BSI schiebt dir wortlos eine Visitenkarte über den Tisch. "Falls Sie es irgendwann eine Nummer größer wollen." Jens, der neben dir sitzt und aussieht, als hätte er drei Tage in einem Serverraum gelebt (hat er auch), nickt dir zu — das lange, langsame Nicken, das bei ihm eine Umarmung ist. Henry boxt dir gegen die Schulter. Und Bjorg erklärt gerade ungefragt der Runde: "Wie ich immer sage: Teamwork, kennste? Kennste?" Jens und Henry wechseln einen Blick. Niemand sagt etwas.',
  ...
  neutral: {
    ...
    paragraphs: [
      ...
      'Jens findet dich abends am Automaten, beide zu müde für große Worte — was bei Jens ohnehin nie das Problem war. Er drückt dir einen Kaffee in die Hand. "Wir leben. Die Müllabfuhr fährt. Beim nächsten Mal sind wir schneller." Es klingt nicht nach Trost. Es klingt nach einem Versprechen. Aus dem Flur ruft Bjorg, man müsse "das alles mal bei einem Bierchen aufarbeiten — ich organisier das!" Er wird es nicht organisieren.',
    ],
    epilogue:
  ...
  bad: {
    ...
    paragraphs: [
      ...
      'An der Tür warten Jens und Henry. Henry nimmt dir den Karton ab, ohne dass du fragen musst. "Weißt du", sagt Jens, "du weißt jetzt Dinge über KRITIS, die die meisten nie lernen, weil sie nie so nah dran waren. Irgendwo da draußen wartet ein Laden, der genau das braucht." Er drückt dir die Hand. "Und die suchen keine Zeugnisse. Die suchen Leute, die schon mal im Feuer standen." Vom Schreibtisch aus winkt Bjorg: "Halt die Ohren steif! Neuer Job ist wie neue Frau — erst aufregend, dann Arbeit! Kennste?" Niemand lacht. Henry trägt deinen Karton bis zum Auto.',
    ],
    epilogue:
