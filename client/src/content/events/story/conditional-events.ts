...
Der PC hat drei Tage lang Daten nach aussen gesendet.`,
    ...
    choices: [
      ...
      {
        id: 'quick_reimage',
        text: 'Keine Zeit fuer grossen Aufwand: PC platt machen, neu aufsetzen, weiter',
        ...
        resultText: 'Schnell erledigt - aber du weisst nicht, was abgeflossen ist, ob andere Systeme betroffen sind, und das BSI wurde nie informiert. Drei Tage Datenabfluss bleiben unaufgeklaert - und die Meldepflicht ist verletzt.',
        choiceTags: ['shortcut', 'risky'],
        setsFlags: ['breach_uninvestigated'],
        teachingMoment: 'Neu aufsetzen loescht die Spuren, nicht das Problem: ohne Analyse weisst du nicht, was kompromittiert wurde - und die Meldepflicht bleibt verletzt.',
      },
    ],
...
Und sie kommuniziert mit einer IP in Russland.`,
    ...
    choices: [
      ...
      },
      {
        ...
        resultText: 'Sophos schlaegt sofort an und sperrt die .exe in Quarantaene - aber die Datei hat schon tagelang mit Russland kommuniziert. Was sie abgegriffen hat, untersucht niemand.',
        choiceTags: ['shortcut', 'risky'],
        teachingMoment: 'Die Ausnahme zu entfernen stoppt vielleicht die Datei, klaert aber weder den bereits erfolgten Abfluss noch moegliche Persistenz. Ein aktiver C2-Fund gehoert untersucht, nicht weggeklickt.',
      },
    ],
...
Du erinnerst dich: Das war, als der externe Dienstleister die Zugangsdaten vom {chef} benutzt hat.`,
    ...
    choices: [
      ...
      },
      {
        ...
        resultText: 'Der Pruefer glaubt dir nicht - die Logs sind eindeutig. Jetzt steht im Bericht nicht nur "geteilte Zugangsdaten", sondern auch "Verschleierungsversuch gegenueber dem Auditor". Deutlich schlimmer.',
        choiceTags: ['deflect', 'risky'],
        teachingMoment: 'Einen Auditor anzuschwindeln macht aus einem Befund zwei: den urspruenglichen Verstoss plus mangelnde Kooperation. Ehrlichkeit ist im Audit fast immer billiger.',
      },
    ],
