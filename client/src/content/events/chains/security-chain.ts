...
"Verdächtige Mail bekommen" - 7 Meldungen
...
Der Sophos-Dashboard zeigt: 47 geblockte Mails. Aber wie viele sind durchgekommen?`,
    ...
    mentorNote: 'Phishing-Wellen erfordern schnelles, koordiniertes Handeln: 1) Ausmass feststellen, 2) Sofortige Kommunikation an alle, 3) Betroffene identifizieren, 4) Schadensbegrenzung, 5) Dokumentation fürs BSI. Bei KRITIS meldepflichtig!',
    choices: [
      {
        id: 'phishing_allhands',
        text: 'Sofort Warnmail an alle + Sophos-Logs prüfen',
      ...
      },
      {
        ...
        resultText: 'Nach 2 Stunden Einzelgesprächen hast du erst die Hälfte der Meldungen bearbeitet. Inzwischen haben weitere Leute geklickt.',
...
Die Phishing-Mail war erfolgreich. Jemand hat nicht nur geklickt, sondern auch Makros aktiviert.`,
    ...
    mentorNote: 'PowerShell-basierte Angriffe sind Standard bei modernen Attacken. "Invoke-Expression" mit "DownloadString" ist ein klassisches Pattern für Stage-2-Payloads. Sofortiges Netzwerk-Isolieren ist kritisch.',
    choices: [
      {
        id: 'sophos_isolate',
        ...
        resultText: 'Du rennst zur Buchhaltung und ziehst das Netzwerkkabel. "Was machen Sie da?!" - "Ihr PC ist kompromittiert." Du sicherst das RAM-Image, bevor du ihn herunterfährst.',
      ...
      {
        id: 'sophos_scan',
        text: 'Einen vollständigen Virenscan auf dem PC starten',
        effects: { stress: 10, skills: { security: -3 } },
        resultText: 'Während des Scans (geschätzte Dauer: 4 Stunden) hat der Angreifer längst Zeit, weiteren Schaden anzurichten.',
      ...
      },
      {
        ...
        resultText: '"Ich habe nur eine Excel-Datei geöffnet! Von DHL!" Sie versteht nicht, warum du sie so scharf angehst. Währenddessen läuft der Angriff weiter.',
...
{chef} ruft dich in sein Büro. Dort sitzt auch der Bürgermeister.

"Unsere IT-Abteilung hat einen gezielten Cyberangriff erfolgreich abgewehrt", sagt {chef}. "Ohne schnelles Handeln hätte der Angreifer Zugriff auf Finanzdaten von 12.000 Bürgern bekommen können."

Der Bürgermeister schüttelt dir die Hand. "Das BSI hat uns bestätigt, dass unsere Reaktion vorbildlich war."`,
    involvedCharacters: ['chef', 'kaemmerer'],
    mentorNote: 'Gute Incident Response wird bemerkt. Dokumentiere immer, was du getan hast - sowohl für die eigene Verteidigung als auch für die Anerkennung.',
    choices: [
      {
        id: 'hero_humble',
        text: '"Das war Teamarbeit. Ohne die schnelle Kommunikation hätten mehr Leute geklickt."',
        effects: { relationships: { chef: 10, kollegen: 10 }, skills: { softSkills: 10 }, stress: -20 },
        resultText: '{chef} lächelt. "Bescheiden auch noch. Das ist selten." Der Bürgermeister: "Wir brauchen mehr Leute wie Sie in der Verwaltung."',
        teachingMoment: 'Erfolge teilen stärkt das Team und macht dich nicht kleiner - es zeigt Reife.',
      },
      {
        id: 'hero_accept',
        text: 'Das Lob dankbar annehmen',
        effects: { relationships: { chef: 5 }, stress: -15 },
        resultText: '"Danke. Ich habe nur das getan, wofür ich ausgebildet wurde." Der Bürgermeister nickt anerkennend.',
      },
      {
        id: 'hero_improve',
        text: '"Wir müssen trotzdem die Awareness-Schulung verbessern - 12 Klicks waren zu viele."',
        effects: { relationships: { chef: 15 }, skills: { softSkills: 5 }, stress: -10 },
        resultText: '{chef}: "Genau das wollte ich hören. Wir werden das Budget für Schulungen erhöhen." Der Bürgermeister: "Machen Sie einen Vorschlag."',
...
Die forensische Analyse zeigt: 4 Stunden Zugriff auf das Buchhaltungsnetzwerk. Export von zwei Datenbanken. Möglicherweise 8.000 Datensätze mit Bankverbindungen.

{chef} ist kreidebleich. "Das ist meldepflichtig. An das BSI UND an den Landesdatenschutzbeauftragten. UND an alle Betroffenen."

{kaemmerer} sitzt mit dem Kopf in den Händen. "Was wird das kosten?"`,
    involvedCharacters: ['chef', 'kaemmerer'],
    mentorNote: 'Datenschutzverletzungen nach DSGVO: 72 Stunden Meldefrist an die Aufsichtsbehörde. Bei KRITIS zusätzlich BSI-Meldung. Die Kosten eines Breaches gehen weit über das technische hinaus: Reputation, Vertrauen, Bussgelder.',
    choices: [
      {
        id: 'breach_lead',
        text: 'Die Incident-Response-Dokumentation übernehmen',
        requires: { skill: 'security', threshold: 30 },
        effects: { skills: { security: 8, softSkills: 5 }, stress: 20, relationships: { chef: 10 } },
        resultText: 'Du erstellst den Incident-Report für das BSI und koordinierst die Meldungen. Es ist stressig, aber du lernst dabei ungemein viel.',
        teachingMoment: 'Incident Documentation ist eine wichtige Fähigkeit. Templates vorher erstellen spart im Ernstfall Zeit.',
      },
      {
        id: 'breach_blame',
        text: '"Wenn ich früher informiert worden wäre..."',
        effects: { relationships: { chef: -15, kollegen: -10 }, stress: 10 },
        resultText: '{chef}: "Jetzt ist nicht die Zeit für Schuldzuweisungen." Aber alle haben gehört, was du gesagt hast.',
        choiceTags: ['blame'],
      },
      {
        id: 'breach_learn',
        text: '"Was können wir tun, damit das nie wieder passiert?"',
      ...
      },
      {
        ...
        effects: { stress: 15 },
        resultText: 'Die nächsten Wochen sind ein Chaos aus BSI-Anfragen, Pressemitteilungen und wütenden Bürgern. Du tauchst unter.',
        choiceTags: ['passive'],
      },
    ],
